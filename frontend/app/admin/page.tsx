            ...
            <div className="panelBody">
              ...
              <div className="msg" style={{ marginTop: 10 }}>
                ...
                <div className="small" style={{ marginBottom: 6 }}>
                  ...
                  {progress?.trial
                    ? `Trial ${progress.trial}/${progress.trial_total ?? "?"}`
                    : ""}
                </div>
                <div
                  className="msgText"
            ...
            <div className="panelBody">
              <div className="msg" style={{ marginBottom: 10 }}>
                ...
                <div className="small" style={{ marginBottom: 8 }}>
                  - 제외(exclude): dataset 생성/compile 대상에서 제외됨
                  <br />- 품질 라벨 bad: 기본적으로 dataset 생성에서 제외됨
                </div>
                <div
                  className="msgText"
                  style={{
                    ...
                    return (
                      ...
                      >
                        <div className="small">
                          ...
                          {err ? (
                            <span
                              style={{ marginLeft: 8, color: "rgba(251, 113, 133, 0.95)" }}
                            >
                        ...
                        <div className="row" style={{ marginTop: 8 }}>
                          ...
                          <button
                            ...
                            style={{
                              padding: "8px 10px",
                              borderColor:
                                quality === "good" ? "rgba(52, 211, 153, 0.65)" : undefined,
                              background:
                                quality === "good" ? "rgba(52, 211, 153, 0.18)" : undefined,
                            }}
                          ...
                          <button
                            ...
                            style={{
                              padding: "8px 10px",
                              borderColor:
                                quality === "bad" ? "rgba(251, 113, 133, 0.7)" : undefined,
                              background:
                                quality === "bad" ? "rgba(251, 113, 133, 0.18)" : undefined,
                            }}
                          ...
                          <button
                            ...
                            style={{
                              padding: "8px 10px",
                              borderColor:
                                quality === "unknown" ? "rgba(255,255,255,0.2)" : undefined,
                              background:
                                quality === "unknown" ? "rgba(255,255,255,0.06)" : undefined,
                            }}
